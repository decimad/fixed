...
namespace
{
    ...
    void range_mul_test()
    {
        ...
        using result_type
            = detail::add_result_value_type_t<std::decay_t<decltype(angle)>::range_type, std::decay_t<decltype(angle)>::range_type>;
    ...
    void macro_test()
    {
        ...
        using range_type = ::fix::value_range<::fix::detail::value_type_t<(bits) + (32 - bits), ::fix::util::any_neg(-2.45, 10.45)>,
                                              ::fix::detail::to_fixed<bits, 32 - bits, ::fix::util::any_neg(-2.45, 10.45)>(-2.45),
                                              ::fix::detail::to_fixed<bits, 32 - bits, ::fix::util::any_neg(-2.45, 10.45)>(10.45)>;
